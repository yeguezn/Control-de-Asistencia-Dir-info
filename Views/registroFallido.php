	...
	<body>
    	...
    	<?php endif; ?>
      	...
      	<form action="?controller=Registrar&action=registrarPersona" method="POST">
            ...
            <input name="cedula" type="text" class="input" id="cedulaId" value="<?php echo $_POST['cedula'];?>">
            
            <label for="nombreId">Nombre y Apellido</label>
        	
            <input name="nombre" type="text" class="input" id="nombreId" value="<?php echo $_POST['nombre'];?>">
            
            <label for="telefonoId">Número de telefono</label>
        	
            <input name="telefono" type="text" class="input" id="telefonoId" value="<?php echo $_POST['telefono'];?>">
            
            <label for="telefono2Id">Segundo número de telefono (opcional)</label>
        	
            <input name="telefono2" type="text" class="input" id="telefono2Id" value="<?php echo $_POST['telefono2'];?>">
            
            <label for="domicilioId">Domicilio</label>
        	
            <textarea name="domicilio" type="text" class="input" id="domicilioId"><?php echo $_POST['domicilio'];?></textarea>
